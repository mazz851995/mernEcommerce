                ...
                <Fragment>
                    ...
                    <Dialog aria-labelledby="simple-dialog-title" open={open} onClose={submitReviewToggle} >
                        ...
                        <DialogContent className="submitDialog">
                            <Rating name="rating" onChange={(e) => setRating(e.target.value)} value={rating} size="large" />
                            <textarea name="comment" className="submitDialogTextArea" cols="30" rows="5" value={comment} onChange={(e) => setComment(e.target.value)} ></textarea>
                        </DialogContent>
                        <DialogActions>
